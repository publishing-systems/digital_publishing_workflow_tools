...
{
    public EntityResolverLocal(File configFile) throws ProgramTerminationException
    {
    ...
    private static final String L10N_BUNDLE = "l10n.l10nEntityResolverLocalConsole";
